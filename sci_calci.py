...
for j in range(2, 5):
    for k in range(3):
        ...
        i += 1
#================================Operation buttons for standard calculator==============================================
...
btnMulti = Button(calc, text="*", width=6, height=2, font=('arial', 20, 'bold'), bd=4,
                  bg="grey", command=lambda: added_value.operation("multi")).grid(row=3, column=3, pady=1)
btnDivide = Button(calc, text="/", width=6, height=2, font=('arial', 20, 'bold'), bd=4,
...
btnDot = Button(calc, text=".", width=6, height=2, font=('arial', 20, 'bold'), bd=4,
                  bg="grey", command=lambda: added_value.numberEnter(".")).grid(row=5, column=1, pady=1)
...
lblDisplay =Label(calc, text="Scientific Calculator", font=('arial', 20, 'bold'), bg="white", justify=CENTER)
